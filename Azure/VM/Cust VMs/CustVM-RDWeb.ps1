## Begin Variables    
#Global
$ResourceGroupName = "RG-SAVE-Core-RDS"
$Location = "WestEurope"
...
$Interface = New-AzureRmNetworkInterface -Name $InterfaceName -ResourceGroupName $ResourceGroupName -Location $Location -SubnetId $VNet.Subnets[7].Id 
